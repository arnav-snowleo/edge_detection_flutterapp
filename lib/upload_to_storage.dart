...
import 'package:opencv_canny_test/ui/screens/fetched.dart';
              ...
              children: [
                ...
                ElevatedButton.icon(
                  onPressed: () => Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => const Fetched()),
                  ),
                  icon: const Icon(Icons.camera),
                ...
                builder: (context,
                  ...
                  if (snapshot.connectionState == ConnectionState.done) {
                    return GridView.builder(
                      ...
                      itemBuilder: (ctx, idx) {
                        final Map<String, dynamic> image = snapshot.data![idx];
